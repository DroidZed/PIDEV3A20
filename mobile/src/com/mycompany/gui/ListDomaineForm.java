 ...
 * @author User
 */
public class ListDomaineForm extends BaseForm{
    
    Form current;
    
    public ListDomaineForm(Resources res)
    {
...
//        rbs[0].setSelected(true);
      ...
      //appel affichage method
      
      ArrayList<domain>list = ServiceDomain.getInstance().afficherDomain();
      for (domain dd : list) {
  ...
  private void addTab(Tabs swipe, Label spacer, Image image, String string, String text, Resources res) 
    ...
    private void addButton(Image img, String name,domain dd) {
