...
public class Post {
    ...
    public Post(int idPost, String titlePost, String descPost, int statusPost, Date startDTM, Date endDTM) {
	this.idPost = idPost;
    ...
    public void setOwnerUser(int idOwnerUser) {
	this.idOwnerUser = idOwnerUser;
    }

    @Override
    public String toString() {
	return " ,Post Title = " + titlePost
