 ...
 */
final class Version20220424080227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tbl_product ADD image VARCHAR(255) NOT NULL, ADD createdDTM DATE DEFAULT \'CURRENT_TIMESTAMP\' NOT NULL, ADD updated_at DATETIME NOT NULL, CHANGE nameProduct nameproduct VARCHAR(255) NOT NULL, CHANGE idCategory idCategory INT DEFAULT NULL, CHANGE idUser idUser INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tbl_product DROP image, DROP createdDTM, DROP updated_at, CHANGE nameproduct nameProduct VARCHAR(100) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE imageProduct imageProduct VARCHAR(150) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE idCategory idCategory INT NOT NULL, CHANGE idUser idUser INT NOT NULL');
